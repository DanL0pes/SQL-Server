...
INSERT INTO tbNivel(descricaoNivel)
	VALUES
		...
		,('INTERMEDIÁRIO')
		,('NOITE')
--	SELECT descricaoNivel FROM tbNivel
...
INSERT INTO tbPeriodo(descricaoPeriodo)
	VALUES
		...
		,('TARDE')
		,('NOITE')
--	SELECT descricaoPeriodo FROM tbPeriodo
...
INSERT INTO tbTelefoneAluno(numTelAluno, codAluno)	
	VALUES
		...
		,('91982523661',3)
		,('9129306040',4)
--	SELECT numTelAluno, codAluno FROM tbTelefoneAluno
...
--	SELECT descricaoTurma, codCurso, codNivel, codPeriodo, horario, diaDaSemana FROM tbTurma
